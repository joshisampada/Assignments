...
public class AddToCart extends TestBase
{
	...
	public void addToCart() throws InterruptedException
	{
	  ...
	  WebElement notify;
	  notify= wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(objectrepoProps.getProperty("notification"))));
	 ...
	 driver.findElement(By.xpath(objectrepoProps.getProperty("navigateToClearancePage"))).click();
	  ...
	  String productInCart=driver.findElement(By.xpath("//span[@class=\"headerCartItemsCount\"]")).getText();
	  System.out.println(productInCart);
	  driver.findElement(By.xpath("(//input[@type=\"submit\"])[4]")).click();;
	  String productInCart1=driver.findElement(By.xpath("//span[@class=\"headerCartItemsCount\"]")).getText();
